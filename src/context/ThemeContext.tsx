...
interface ThemeWithId extends Theme {
    id: string;
}
...
export const ThemeProvider: React.FC<ThemeProviderProps> = ({ children }) => {
    ...
    const applyTheme = (id: string): void => {
        ...
        const containers = document.querySelectorAll<HTMLElement>('[class*="bg-"], [class*="min-h-screen"]');
    ...
    const themesArray: ThemeWithId[] = Object.entries(THEMES).map(([id, themeData]) => ({
        id,
        ...themeData
    }));
...
export { THEMES };
export type { Theme, ThemeWithId, ThemeContextValue };
